...
// LoadOperations loads the operations from horizon.
func (c *Client) LoadOperations(params ...interface{}) (operations OperationsPage, err error) {
	c.fixURLOnce.Do(c.fixURL)
	query := url.Values{}
	...
	err = decodeResponse(resp, &operations)
	return
}
